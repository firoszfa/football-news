...
from main.views import show_main, add_news_entry_ajax, create_news, show_news, edit_news, delete_news, show_xml, show_json, show_xml_by_id, show_json_by_id, register, login_user, logout_user
